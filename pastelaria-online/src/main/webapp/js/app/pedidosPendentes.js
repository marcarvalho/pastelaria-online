...
function atualizarTabela(evt) {  
	if (evt.data) {
		...
		console.log('WebSocket nao retornou dados');  
	}	
}
...
$(document).ready(function() {
	...
	(function(){
	    window.addEventListener("load", init("ws://localhost:8080/pastelaria-online/notificacao", atualizarTabela), false);	
	})();	
	...
	(function() {
		$.ajax({
			...
			console.log('Ocorreu um erro ao buscar os pedidos cadastrados: ' + jqXHR);
		}).always(function(data,textStatus, jqXHR){
